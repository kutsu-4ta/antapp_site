                ...
                <Grid container justifyContent="center" className="content-top padding-3">
                    ...
                    <Grid item xs={12} className="text-size-body">
                        <Item className="margin-top-2">
                            ...
                            以前はネットワークやサーバサイドをメインでやっていて、
                            Laravel,PHP,Vue.jsあたりを主に使っていました。<br/>
                            最近はフロント・ エンド周りが好きで、React.jsの練習としてこのサイトを作成しました。<br/>
                            業務で扱っていた言語とフレームワークをSkillSetのページに載せていますのでご覧ください。<br/>
                            {/*スーパーカブでキャンプに出かけたり、音楽や読書が好きです。<br/>*/}
                        </Item>
                    </Grid>
                </Grid>
            </IsPc>
